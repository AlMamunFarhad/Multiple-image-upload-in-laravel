          ...
          <form action="" name="product" id="product" method="post">
            <div class="card w-100 shadow-lg">
                ...
                <div class="row g-3 card-body">
                    ...
                    <div>
                        <button class="btn btn-success d-flex" width="100" type="submit">Create</button>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        const dropzone = $("#image").dropzone({
            ...
            success: function(file, response) {
                ...
                let html = `<div class="col-md-4 shadow-lg" id="product-image-row-${response.image_id}">
                <div class="card">
            ...
            $("button[type=submit]").prop('disabled', false);
             if(response.status == true){
              ...
              let errors = response.errors
                 ...
                 if (errors.price) {
                   $('#price').addClass('is-invalid').siblings("p").addClass('invalid-feedback').html(errors.name);
